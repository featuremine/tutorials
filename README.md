...
In this section we use two docker containers to illustrate a distrubuted setup. This might be useful if you have multiple consumers of the market data. To accomplish this we use `Syncer`, which syncronizes data between yamal files on different machines.
...
At this point you should see dashboard updating with the latest statistics.